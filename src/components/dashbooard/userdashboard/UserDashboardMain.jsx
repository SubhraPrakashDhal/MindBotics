        ...
        <div className="h-full rounded-2xl shadow-2xl flex flex-col bg-gradient-to-b from-[#111827] to-[#020617] text-white border border-white/10">
          <div className="p-6 text-center border-b border-white/10">
            <div className="w-20 h-20 mx-auto rounded-full bg-gradient-to-r from-cyan-400 to-blue-500 flex items-center justify-center text-3xl font-bold overflow-hidden">
              <img className="w-full h-full object-cover rounded-full" src="https://i.pravatar.cc/150" alt="profile" />
            </div>
          ...
          <div className="flex-1 px-4 py-6">
            <ul className="flex flex-col gap-3">
              <li>
                <NavLink to="/userdashboard" className="flex items-center gap-3 px-4 py-3 rounded-xl bg-white/5 hover:bg-gradient-to-r hover:from-cyan-400 hover:to-blue-500 hover:text-black transition-all duration-300">
                  <BsCollectionPlay /> Dashboard
                </NavLink>
              </li>
              <li>
                <NavLink to="/userdashboard/createpost/1" className="flex items-center gap-3 px-4 py-3 rounded-xl bg-white/5 hover:bg-gradient-to-r hover:from-cyan-400 hover:to-blue-500 hover:text-black transition-all duration-300">
                  <FaPlus /> Devices
                </NavLink>
              </li>
              <li>
              ...
              <li>
                <NavLink to="/userdashboard/settings/1" className="flex items-center gap-3 px-4 py-3 rounded-xl bg-white/5 hover:bg-gradient-to-r hover:from-cyan-400 hover:to-blue-500 hover:text-black transition-all duration-300">
                  <FaCog /> Settings
                </NavLink>
              </li>
            </ul>
